...
public class FreePatchUtil {
	...
	public static String projectPath="D:/DHCSoftware/Mat8.4/V9.0/CHD-HRP";//项目文件夹路径
	
	public static String webContent="WebRoot";//web应用文件夹名
	
	public static String classPath="D:/DHCSoftware/Mat8.4/V9.0/CHD-HRP/WebRoot/WEB-INF/classes";//class存放路径
	
	public static String desPath="D:/v9.0-Package/myself";//补丁文件包存放路径
	
	public static String version="20200605001";//补丁版本
